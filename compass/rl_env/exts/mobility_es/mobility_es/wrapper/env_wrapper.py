    ...
    def __init__(self,
        ...
        Args:
            ...
            precompute_valid_poses (bool, optional): Whether to precompute valid pose locations.
                Defaults to False.
            precompute_valid_orientations (bool, optional): Whether to use precomputed valid
                orientations. If False, uses randomly generated orientations. Defaults to False.
